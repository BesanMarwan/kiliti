...
return [
    ...
    'documentations' => [
        'general' => [
            ...
            'routes' => [
                ...
                */
                'api' => 'api/documentation/general',
                'docs' => '/api/general/docs',
                'oauth2_callback' => '/api/general/callback',
            ],
            'paths' => [
                /*
                ...
                */
                'docs_json' => 'api-docs-gen.json',

                /*
                 * File name of the generated YAML documentation file
                */
                'docs_yaml' => 'api-docs-gen.yaml',
                ...
                */
                'annotations' => [
                    base_path('app').'/Http/Controllers/Api/V1/General',
                    base_path('app').'/Http/Requests/Api/General',
                    base_path('app').'/Http/Resources/General',
                ],
        ...
        'user' => [
            ...
            'paths' => [
                ...
                */
                'annotations' => [
                    base_path('app').'/Http/Controllers/Api/V1/User',
                    base_path('app').'/Http/Requests/Api/General',
                    base_path('app').'/Http/Requests/Api/User',
                    base_path('app').'/Http/Resources/General',
    ...
    'user' => [
        ...
        'paths' => [
             ...
             * Absolute path to location where parsed annotations will be stored
            */
            'docs' => storage_path('api-docs-user'),
