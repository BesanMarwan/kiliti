...
@section('page_title')
    <x-header.title name="wizard">
        <x-header.breadcrumb-item href="#" name="الصلاحيات"/>
        <x-header.breadcrumb-item name="wizard"/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <label
                                        ...
                                        <span class="d-block fw-bold text-start">
																		<span
                                                                            class="text-dark fw-bolder d-block fs-4 mb-2">Personal Account</span>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <label
                                        ...
                                        <span class="d-block fw-bold text-start">
																		<span
                                                                            class="text-dark fw-bolder d-block fs-4 mb-2">Corporate Account</span>
                                    ...
                                    <span class="d-flex align-items-center me-2">
                                        ...
                                        <!--begin::Description-->
																	<span class="d-flex flex-column">
																		<span
                                                                            class="fw-bolder text-gray-800 text-hover-primary fs-5">Company Account</span>
                                ...
                                <label class="d-flex flex-stack mb-5 cursor-pointer">
                                    ...
                                    <span class="d-flex align-items-center me-2">
                                        ...
                                        <!--begin::Description-->
																	<span class="d-flex flex-column">
																		<span
                                                                            class="fw-bolder text-gray-800 text-hover-primary fs-5">Developer Account</span>
                                ...
                                <label class="d-flex flex-stack mb-0 cursor-pointer">
                                    ...
                                    <span class="d-flex align-items-center me-2">
                                        ...
                                        <!--begin::Description-->
																	<span class="d-flex flex-column">
																		<span
                                                                            class="fw-bolder text-gray-800 text-hover-primary fs-5">Testing Account</span>
																			...
																			<g stroke="none" stroke-width="1"
                                                                               fill="none" fill-rule="evenodd">
																				...
																				<rect fill="#000000" opacity="0.3" x="2"
                                                                                      y="5" width="20" height="14"
                                                                                      rx="2"/>
																				<rect fill="#000000" x="2" y="8"
                                                                                      width="20" height="3"/>
																				<rect fill="#000000" opacity="0.3"
                                                                                      x="16" y="14" width="4" height="2"
                                                                                      rx="1"/>
																			</g>
																		</svg>
																	</span>
                ...
                <div class="d-flex flex-stack pt-10">
                    ...
                    <div class="mr-2">
                        <button type="button" class="btn btn-lg btn-light-primary me-3"
                            ...
                            <span class="svg-icon svg-icon-4 me-1"><x-metronic-Right-2/></span>
                            <!--end::Svg Icon-->Back
                        </button>
                    </div>
                    <!--end::Wrapper-->
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-lg btn-primary" data-kt-stepper-action="next">
                            Continue
                            <span class="svg-icon svg-icon-4 ms-1 me-0"><x-metronic-Left-2/></span>
                        </button>
                    </div>
                    <!--end::Wrapper-->
                </div>
...
@push('js')
    ...
    <script>
        ...
        const submitButton = form.querySelector('[data-kt-stepper-action="submit"]');
